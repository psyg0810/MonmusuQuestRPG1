...
module NWConst::PartyManager
  ...
  # ● 城待機メンバーに存在するか？
  #--------------------------------------------------------------------------
  def exist_stand_actor_id?(id)
    $game_party.exist_stand_actor_id?(id)
  end
  #--------------------------------------------------------------------------
  # ● 全てのメンバーに存在するか？
  #--------------------------------------------------------------------------
  def exist_all_actor_id?(id)
    $game_party.exist_all_actor_id?(id)
  end
  #--------------------------------------------------------------------------
  # ● 城待機メンバーを加える
  #--------------------------------------------------------------------------
...
class Game_Party < Game_Unit
  ...
  #--------------------------------------------------------------------------
  # ● メンバーから指定のIDのアクターが存在するか？
  #--------------------------------------------------------------------------
  def exist_actor_id?(actor_id)
  ...
  #--------------------------------------------------------------------------
  def exist_stand_actor_id?(id)
    @stand_actors.include?(id)
  end
  #--------------------------------------------------------------------------
  # ● 全てのメンバーに存在するか？
  #--------------------------------------------------------------------------
  def exist_all_actor_id?(id)
    exist_actor_id?(id) || exist_stand_actor_id?(id)
  end
  #--------------------------------------------------------------------------
  # ○ アクターを加える
  #--------------------------------------------------------------------------
...
class Foo::PTEdit::Window_PartyMember < Window_Command
  ...
  def make_command_list
    ...
    (8 - @actors.size).times{add_command(no_actor_name, :ok)}
    # ルカの固定
