...
module NWConst::Field
  ...
  BGM = {
    ...
    2 => {
      ...
      22 => RPG::BGM.new("field2", 100, 100),
      23 => RPG::BGM.new("field2", 100, 100),
      24 => RPG::BGM.new("field2", 100, 100),
  ...
  TERRAIN = {
    :森 => {
      ...
      :map_id => [
        ...
        332, 333, 415, 416, 417, 443, 670, 674,
      ],
     },
    :砂漠 => {
      :tag => 2,
    ...
    :市街 => {
      :tag => -1,
      :map_id => [
         23,  24,  29,  45,  46,  55,  56, 164, 176, 177,
        185, 219, 225, 226, 279, 280, 338, 359, 360, 361,
        362, 363, 378, 387, 388, 389, 483, 513, 515, 616,
        624, 679, 681, 682, 683, 684, 686, 687, 688, 689,
