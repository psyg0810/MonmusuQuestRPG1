...
module NWConst::Status
  # 項目名
  ROOT_COMMAND          = ["基本情報","装備構成","職業種族履歴","固有アビリティ"]
  BASIC_COMMAND         = ["基本能力", "特殊能力", "属性耐性", "状態異常耐性"]
  CLASS_HISTORY_COMMAND = ["職業", "種族"]
  # 基本能力
  BASIC_PARAM_VOCAB     = [
    "最大ＨＰ", "最大ＭＰ", "攻撃力", "防御力", "魔力", "精神力", "素早さ", "器用さ",
    "命中率", "会心率", "回避率", "魔法回避率", "カウンター率", "魔法カウンター率"
  ]
  # 特殊能力
  SPECIAL_PARAM_VOCAB   = [
    "HP再生率", "MP再生率", "SP再生率", "SPチャージ率", "MP消費率", "SP消費率",
    "回復効果率", "アイテム効果率", "盗み成功率", "魔法反射率",
    "経験獲得率", "職業経験獲得率", "獲得金額倍率", "獲得アイテム倍率"
  ]
  # 属性対応アイコンID
...
#~       (1..5).collect{|i| "装備品#{i}"},
      $data_system.terms.etypes.collect{|etype| etype + "情報"},
